...
import 'package:clinica_flow/features/payment/view/payment_record_listTile.dart';
// import 'package:clinica_flow/Screens/payment_records/provider/payment_provider.dart';
        ...
        return ListView(
          ...
          children: [
            ...
            if (searchResult?.isNotEmpty ?? true)
              Text(
                  'All ${searchResult != null ? searchResult!.length : state.payments?.length ?? ''} Payments Records are Listed'),
            ...
            searchResult?.isNotEmpty ?? true
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final payment = searchResult != null
                          ? searchResult![index]
