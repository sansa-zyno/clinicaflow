...
import '../../../shared/widgets/green_line.dart';
...
class _PaymentsReceiptInvoiceState extends State<PaymentsReceiptInvoice> {
      ...
      body: BlocBuilder<AppointmentCubit, AppointmentState>(
        ...
        return ListView(
          ...
          children: [
            ...
            topRow(state.invoiceDetails!.invoiceNumber!,
                state.invoiceDetails!.appointment!.appointmentDate!),
            const SizedBox(
              height: 16,
            ),
            RichText(
              text: TextSpan(
                children: [
                  ...
                  TextSpan(
                    text:
                        '${state.invoiceDetails!.patient!.firstName} ${state.invoiceDetails!.patient!.lastName}',
            ...
            Column(
              children: [
                custom(
                    "Total Amt.",
                    "-",
                    state.invoiceDetails!.totalAmount.toString(),
                    "INR",
                ...
                custom(
                    "Total Tax",
                    "-",
                    state.invoiceDetails!.totalTax.toString(),
                    "INR",
                    const TextStyle(fontWeight: FontWeight.w600, fontSize: 16),
                    const TextStyle(fontWeight: FontWeight.w500, fontSize: 16)),
                const SizedBox(height: 17),
                ...
                const SizedBox(height: 17),
                custom(
                    "Discount @${state.invoiceDetails!.discountRate}%",
                    "-",
                    state.invoiceDetails!.discount.toString(),
                    "INR",
                    const TextStyle(fontWeight: FontWeight.w600, fontSize: 16),
                    const TextStyle(fontWeight: FontWeight.w500, fontSize: 16)),
              ],
                      ...
                      children: [
                        Expanded(
                          child: Center(
                            child: InkWell(
                              onTap: () {
                                if ((state.invoiceDetails?.paidAmount ?? -1) ==
                                    (state.invoiceDetails?.totalAmount ?? -2)) {
  ...
  Widget rowTextfield(String name, TextEditingController controller,
      String hint, bool readOnly) {
    return Row(
      children: [
        Expanded(
          child: Text(
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                rowTextfield("Amount Received", _cashController,
                    "In rupees(INR)", false),
                const SizedBox(height: 8),
                rowTextfield(
                    "Payment Mode", _paymentController, "Payment method", true),
                                    ...
                                    if (_paymentController.text.isNotEmpty) {
                                      context
                                          ...
                                          .setCashPayment(
                                            ...
                                            paymentMode: _paymentController.text
                                                .toLowerCase(),
                                          );
                                    } else {
                                      context.pop();
