...
class PrescriptionReport {
  ...
  factory PrescriptionReport.fromJson(Map<String, dynamic> json) =>
      PrescriptionReport(
        id: json["_id"],
...
class Clinic {
  ...
  factory Clinic.fromJson(Map<String, dynamic> json) => Clinic(
        ...
        adminUserId: json["adminUserId"] != null
            ? AdminUserId.fromJson(json["adminUserId"])
            : null,
      );
}
...
class Prescriptions {
  ...
  factory Prescriptions.fromJson(Map<String, dynamic> json) => Prescriptions(
        ...
        symptoms: json["symptoms"] != null
            ? List<Symptom>.from(
                json["symptoms"].map((x) => Symptom.fromMap(x, 'Sx')))
            : null,
        diagnosis: json["diagnosis"] != null
            ? List<Symptom>.from(
                json["diagnosis"].map((x) => Symptom.fromMap(x, 'Dx')))
            : null,
        appointment: json["appointment"],
        labTests: json["labTests"] != null
            ? List<LabTest>.from(
                json["labTests"].map((x) => LabTest.fromMap(x)))
            : null,
        drugPrescriptions: json["drugPrescriptions"] != null
            ? List<Drug>.from(
                json["drugPrescriptions"].map((x) => Drug.fromMap(x)))
            : null,
