import 'package:clinica_flow/core/utils/template_form_data/template_form_data.dart';
...
class SettingsCubit extends HydratedCubit<SettingsState> {
  ...
  void updateUseAiPredictiveSearch(bool value) {
    final newState = state.copyWith(
        state: SettingsStates.useAiPredictiveSearchUpdated,
        useAiPredictiveSearch: value);
    emit(newState);
  }
  ...
  void updatePreviewPrescriptionbeforePrint(bool value) {
    final newState = state.copyWith(
        state: SettingsStates.previewPrescriptionbeforePrintUpdated,
        previewPrescriptionbeforePrint: value);
    emit(newState);
  }
  ...
  void updateNotifyUserOnWhatsapp(bool value) {
    final newState = state.copyWith(
        state: SettingsStates.notifyUserOnWhatsappUpdated,
        notifyUserOnWhatsapp: value);
    emit(newState);
  }
  ...
  void updateTemplateFormData(TemplateFormData value) {
    final newState = state.copyWith(
        state: SettingsStates.templateFormDataUpdated, templateFormData: value);
    emit(newState);
  }
