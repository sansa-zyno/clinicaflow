...
class ScheduleSuccessfullyScreen extends StatefulWidget {
  ...
  const ScheduleSuccessfullyScreen({required this.appointment, Key? key})
      : super(key: key);

  @override
  State<ScheduleSuccessfullyScreen> createState() =>
      _ScheduleSuccessfullyScreenState();
}
...
class _ScheduleSuccessfullyScreenState extends State<ScheduleSuccessfullyScreen>
          ...
          child: Column(
            ...
            children: [
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                const SizedBox(width: 8),
                                Text(
                                  widget.appointment.virtualConsultation ==
                                          false
                                      ? 'Physical'
                                      : 'Virtual',
                                  style: GoogleFonts.roboto(
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    BlocBuilder<WhatsappMessagingCubit, WhatsappMessagingState>(
                        builder: (context, state) {
                      if (state.state ==
                          WhatsappMessagingStates.sendingMessage) {
                        ...
                        return Padding(
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              height: 52,
                              padding:
                                  const EdgeInsets.fromLTRB(19, 16, 19, 16),
                              decoration: BoxDecoration(
  ...
  /*void _sendWhatsAppMessage(BuildContext context) async {
     final appointments =
        context.read<AppointmentCubit>().state.appointments ?? [];
