...
import 'package:clinica_flow/shared/widgets/appointment_filter.dart';
import 'package:clinica_flow/core/utils/responsive_layout.dart';
import 'package:clinica_flow/shared/widgets/desktop_sidebar.dart';
    ...
    return MultiBlocListener(
      ...
      child: ResponsiveLayout(
        ...
        desktop: Scaffold(
          body: Row(
            children: [
              DesktopSidebar(shell: widget.shell),
              Expanded(
                child: widget.shell,
              ),
            ],
