              ...
              children: [
                ...
                Padding(
                    ...
                    child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          topRow(invoiceDetails.invoiceNumber ?? '',
                              invoiceDetails.appointment?.appointmentDate),
                          SizedBox(height: 16),
                          RichText(
                            text: TextSpan(
                              children: [
                                ...
                                TextSpan(
                                  text:
                                      '${invoiceDetails.patient!.firstName ?? ''} ${invoiceDetails.patient!.lastName ?? ''}',
                                  style: TextStyle(
                                      color: PdfColor(0.42, 0.56, 1, 1),
                                      fontSize: 18,
                                      fontWeight: FontWeight.normal),
                                ),
                              ],
                      ...
                      children: [
                        ...
                        ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              Treatment item =
                                  invoiceDetails.treatments![index];
                              return Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        custom(
                            "Total Amt.",
                            "-",
                            invoiceDetails.totalAmount.toString(),
                            "INR",
                            TextStyle(
                        ...
                        custom(
                            "Total Tax",
                            "-",
                            invoiceDetails.totalTax.toString(),
                            "INR",
                            TextStyle(
                                fontWeight: FontWeight.bold, fontSize: 16),
                            TextStyle(
                        ...
                        SizedBox(height: 17),
                        custom(
                            "Discount @${invoiceDetails.discountRate ?? '0'}%",
                            "-",
                            invoiceDetails.discount.toString(),
                            "INR",
                            TextStyle(
                                fontWeight: FontWeight.bold, fontSize: 16),
                            TextStyle(
                      ...
                      Padding(
                          ...
                          child: custom(
                              ...
                              TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 16,
                                  color: const PdfColor.fromInt(0xff4646B5)),
                              TextStyle(
                                  fontWeight: FontWeight.normal,
                                  fontSize: 16,
                                  color: const PdfColor.fromInt(0xff4646B5)))),
