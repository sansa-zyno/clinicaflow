...
EdgeInsets getPadding({required BuildContext context, double? all, double? left, double? top, double? right, double? bottom}) =>
...
EdgeInsets getMarginOrPadding({required BuildContext context, double? all, double? left, double? top, double? right, double? bottom}) {
  left = all ?? left ?? 0;
  top = all ?? top ?? 0;
  right = all ?? right ?? 0;
  bottom = all ?? bottom ?? 0;
