...
import 'package:clinica_flow/shared/ui/member/add/appointment_settings.dart';
...
class _PaymentDetailScreenState extends State<PaymentDetailScreen> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
                child:
                    SingleChildScrollView(child: _buildBankDetailsSection())),
  ...
  void _onSkip() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => AppointmentSettings(staff: widget.staff),
      ),
    );
  }
