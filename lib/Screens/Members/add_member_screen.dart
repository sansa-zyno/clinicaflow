...
import 'package:healtether_clinic_app/Screens/Members/personal_detail_screen.dart';
...
class AddMemberScreen extends StatefulWidget {
  final bool isAdmin;
  final bool forStaff;
  const AddMemberScreen({super.key, required this.isAdmin, required this.forStaff});
