...
import 'package:healtether_clinic_app/Screens/Members/appointment_settings.dart';
...
class PaymentDetailScreen extends StatefulWidget {
  ...
  const PaymentDetailScreen({super.key, this.pageController, required this.createStaff});
