...
class SaveMedicationHistoryScreen extends StatefulWidget {
  ...
  @override
  State<SaveMedicationHistoryScreen> createState() =>
      _SaveMedicationHistoryScreenState();
}

class _SaveMedicationHistoryScreenState
    extends State<SaveMedicationHistoryScreen> {
  @override
      ...
      child: Center(
        child: Text(
          ...
          style: TextStyle(
            ...
            fontWeight: FontWeight.bold,
            color:
                color == const Color(0xFFF5F5F5) ? Colors.black : Colors.black,
          ),
        ),
      ),
    );
