...
class PatientSufferingFromAllergiesScreen extends StatefulWidget {
  const PatientSufferingFromAllergiesScreen({Key? key}) : super(key: key);

  @override
  State<PatientSufferingFromAllergiesScreen> createState() => _PatientSufferingFromAllergiesScreenState();
}

class _PatientSufferingFromAllergiesScreenState extends State<PatientSufferingFromAllergiesScreen> {
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                context.goNamed(AppRoutes.saveAllergy.name);
      ...
      body: Column(
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              children: [
                buildOptionContainer("Dust"),
                buildOptionContainer("Pollen"),
                buildOptionContainer("Honey"),
                buildOptionContainer("Nuts"),
