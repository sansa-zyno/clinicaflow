...
import 'package:healtether_clinic_app/widgets/containers/sx_dx_container.dart';

class PrivacyNotesSheet extends StatefulWidget {
  const PrivacyNotesSheet({required this.symptom, Key? key, required this.onSave}) : super(key: key);
                        ...
                        child: Padding(
                          ...
                          child: TextField(
                            ...
                            decoration: const InputDecoration(
                              ...
                              hintStyle: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, fontFamily: 'Urbanist', color: Colors.grey),
                            ),
                          ),
                        ),
                      ),
                              ...
                              child: TextButton(
                                ...
                                onPressed: () {
                                  final newSymptom = widget.symptom.copyWith(
                                      ...
                                      // timeUnit: duration,
                                      privateNote: privateNotesController.text.trim());
