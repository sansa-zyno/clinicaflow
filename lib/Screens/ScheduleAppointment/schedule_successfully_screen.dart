...
class ScheduleSuccessfullyScreen extends StatefulWidget {
  ...
  const ScheduleSuccessfullyScreen({required this.appointmentDetails, Key? key})
      : super(key: key);
...
class _ScheduleSuccessfullyScreenState
    extends State<ScheduleSuccessfullyScreen> {
  @override
