...
class ScheduleFollowUp extends StatefulWidget {
  const ScheduleFollowUp({super.key});

  @override
  State<ScheduleFollowUp> createState() => _ScheduleNewAppointmentScreenState();
}

class _ScheduleNewAppointmentScreenState extends State<ScheduleFollowUp> {
  @override
