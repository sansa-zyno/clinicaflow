...
class _ScheduleSearchBoxState extends State<ScheduleSearchBox> with UiInfoMixin {
  // DateTime? _selectedDate;

  String formattedDate = "Today";
  String attendingDoc = "Dr. Ajit Bhalla";

  List<String> attendingDocs = ["Ajit Bhalla", "Kim Jones", "Annie Beasant", "Other"];
            ...
            content: Column(
              ...
              children: [
                ...
                Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    children: List<Widget>.generate(attendingDocs.length, (index) {
